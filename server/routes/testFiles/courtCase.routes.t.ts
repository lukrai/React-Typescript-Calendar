...
export const courtCasesTests = (request: supertest.SuperTest<supertest.Test>): void => {
  describe("Court Case router endpoints", () => {
    ...
    describe("/api/court-case POST court-case ", () => {
      it("/api/court-case POST should create new calendar and reserve the time", async () => {
      ...
      it("/api/court-case POST should create reserve the time if calendar already exists", async () => {
      ...
      it("/api/court-case POST should succeed if no fileNo is passed as payload", async () => {
    ...
    describe("/api/court-case/:id GET court-case ", () => {
      it("/api/court-case/:id GET should return a court case", async () => {
      ...
      it("/api/court-case/:id GET should return 404 if court case is not found", async () => {
      ...
      it("/api/court-case/:id GET should return 500 if court case is not found", async () => {
    ...
    describe("/api/court-case GET all court-cases ", () => {
      it("/api/court-case GET should return all user court cases", async () => {
    ...
    describe("/api/court-case/:id PUT court-case ", () => {
      it("/api/court-case/:id PUT should update and return a court case", async () => {
      ...
      it("/api/court-case/:id PUT should return 404 if court case is not found", async () => {
      ...
      it("/api/court-case/:id PUT should return 500 if court case is not found", async () => {
    ...
    describe("/api/court-case/ PUT disable enable court-case", () => {
      it("/api/court-case/ PUT should update and return a updated and disabled courtcases", async () => {
        const response = await request
          .put(`/api/court-case/`)
          .set("Cookie", cookies)
      ...
      it("/api/court-case/ PUT should return 400 if court case are not sent", async () => {
      ...
      it("/api/court-case/ PUT should return 500 if court cases object has wrong ids", async () => {
        const response = await request
          .put(`/api/court-case`)
          .set("Cookie", cookies)
    ...
    describe("/api/court-case/:id DELETE court-case", () => {
      it("/api/court-case/:id DELETE should return nullified court case", async () => {
      ...
      it("/api/court-case/:id DELETE should return 400 if court case id is invalid", async () => {
      ...
      it("/api/court-case/:id DELETE should return 404 if court case is not found", async () => {
