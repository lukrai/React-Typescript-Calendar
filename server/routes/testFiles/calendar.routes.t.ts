...
export const calendarRoutesTests = (request: supertest.SuperTest<supertest.Test>): void => {
  describe("Calendar router ednpoints", () => {
    ...
    describe("/api/calendar POST calender", () => {
      it("/api/user POST should create and return a Calendar", async () => {
      ...
      it("/api/calendar POST should create and return a Calendar with random string", async () => {
      ...
      it("/api/calendar POST should fail when same date already exists.", async () => {
        const response = await request.post("/api/calendar").set("Cookie", cookies).send({ date: "2019-10-09" });
    ...
    describe("/api/calendar PUT update calendar ", () => {
      it("/api/calendar PUT should return failed message when non eexisting id is passed.", async () => {
      ...
      it("/api/calendar PUT should return updated Calendar.", async () => {
    ...
    describe("/api/calendar GET calendar ", () => {
      it("/api/calendar GET should return all calendars", async () => {
    ...
    describe("/api/calendar/:id GET calendar ", () => {
      it("/api/calendar/:id GET should return existing calendar", async () => {
      ...
      it("/api/calendar/:id GET should fail when wrong selector is passed", async () => {
      ...
      it("/api/calendar/:id GET should create new calendar with initial courtcases", async () => {
    ...
    describe("/api/calendar DELETE calendar ", () => {
      it("/api/calendar Delete should return failed message when non eexisting id is passed.", async () => {
      ...
      it("/api/calendar DELETE should delete Calendar.", async () => {
